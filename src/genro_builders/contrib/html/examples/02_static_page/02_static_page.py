...
"""02 — Static Page: HTML structure, nesting, and attributes.

What you learn:
    - Full HTML structure: html > head + body
    - Nesting: div > h2 + ul > li
    - Attributes: _class (maps to class), id, style, href
    - Underscore prefix for Python-reserved keywords (_class, _for)
    - Chaining: each call returns the created node for further nesting
